...
HELP_CATEGORIES = {
    ...
    "roles": {
        ...
        "commands": [
            ...
            ("/content dashboard", "Edit About Us, WU Strike System, and Family Particulars with private Markdown forms and previews."),
    ...
    "tickets_v2": {
        ...
        "commands": [
            ...
            ("/tickets rollout-rollback", "Return new intake to legacy. Admin only."),
