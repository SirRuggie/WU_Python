...
HELP_CATEGORIES = {
    ...
    "tickets": {
        "name": "Legacy Tickets",
        "emoji": "🎫",
        "description": "Live channel-ticket intake and lifecycle during coexistence",
        "commands": [
            ...
            ("/ticket config", "Inspect legacy ticket settings. Admin only."),
            ("/ticket change-category", "Change a legacy ticket category. Admin only."),
            ("/ticket list", "List open legacy tickets. Recruiter/Admin only."),
            ("/ticket dashboard", "Open legacy ticket management. Recruiter/Admin only."),
    ...
    "ticket_pilot": {
        "name": "Ticket Pilot",
        "emoji": "🧪",
        "description": "Restricted thread-ticket pilot, console, flags, and rollout",
        "commands": [
            ("/ticket-pilot approve", "Approve the current thread ticket. Recruiter/Admin only."),
            ("/ticket-pilot deny", "Deny the current thread ticket. Recruiter/Admin only."),
            ("/ticket-pilot find", "Search permanent thread-ticket history. Recruiter/Admin only."),
            ("/ticket-pilot history", "Open one member's ticket history. Recruiter/Admin only."),
            ("/ticket-pilot flags", "View active applicant flags. Recruiter/Admin only."),
            ("/ticket-pilot flag-add", "Add or update an applicant flag. Recruiter/Admin only."),
            ("/ticket-pilot flag-remove", "Deactivate an applicant flag. Recruiter/Admin only."),
            ("/ticket-pilot setup", "Post and bind the restricted pilot panel. Admin only."),
            ("/ticket-pilot configure-threads", "Validate candidate/staff thread parents. Admin only."),
            ("/ticket-pilot thread-config", "Revalidate thread configuration. Admin only."),
            ("/ticket-pilot console", "Post or repair the recruiter console. Admin only."),
            ("/ticket-pilot config", "Inspect thread-ticket settings. Admin only."),
            ("/ticket-pilot migrate-legacy", "Clone one terminal legacy ticket. Admin only."),
            ("/ticket-pilot approve-migration-pilot", "Continue after verifying migration samples. Admin only."),
            ("/ticket-pilot pilot-user", "Manage pilot user access. Admin only."),
            ("/ticket-pilot pilot-role", "Manage pilot role access. Admin only."),
            ("/ticket-pilot rollout-status", "Show phase, bindings, and drain blockers. Admin only."),
            ("/ticket-pilot rollout-prepare", "Validate and stage the pilot. Admin only."),
            ("/ticket-pilot rollout-pilot", "Enable allowlisted pilot intake. Admin only."),
            ("/ticket-pilot rollout-promote", "Promote thread intake publicly. Admin only."),
            ("/ticket-pilot rollout-rollback", "Return new intake to legacy. Admin only."),
            ("/ticket-pilot rollout-drain", "Verify legacy drain and enter thread-only. Admin only."),
        ],
    },
    "cwl": {
        "name": "CWL & Reminders",
