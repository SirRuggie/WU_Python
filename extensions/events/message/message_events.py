...
# DISABLED - Ticket Automation - 2025-07-25
...
async def on_questionnaire_response(event: hikari.GuildMessageCreateEvent):
    ...
    # Check for goblin challenge (before ticket state check)
    if await goblin_challenge.check_goblin_challenge(event):
        print("[Message Events] Message handled by goblin challenge system")
        return

    # DISABLED - Ticket Automation - 2025-07-25
    # All ticket automation handling has been disabled
    # Keeping only goblin challenge and how to ping functionality
